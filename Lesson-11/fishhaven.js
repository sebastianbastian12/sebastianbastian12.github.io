const key = 'https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=fd15d96290be857f5672c4e23645f6bb';
1
fetch(key)
    .then(data => data.json())
    .then(data2 => {
...
const keyForecast = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=fd15d96290be857f5672c4e23645f6bb';
...
fetch(recurso)
    ...
    .then(datos2 => {
        ...
        document.querySelector('div.events2').appendChild(city);
